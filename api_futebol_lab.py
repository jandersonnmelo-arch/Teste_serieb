...
def extract_named_list(payload, names):
    """Localiza somente o bloco solicitado dentro de response/data.

    Não mistura aliases de jogadores, escalações, estatísticas e eventos.
    Isso evita que a busca por `escalacoes` ou `jogadores` capture por engano
    o bloco de `estatisticas`, deixando o parser de jogadores vazio.
    ...
    # Último recurso: busca recursiva, ainda limitada às chaves solicitadas.
